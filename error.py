...
controller.quorum.bootstrap.servers=:9093
...
clean_slate() {
    rm -Rf /data/kafka_2.13-4.0.0 ; tar zxf /data/kafka_2.13-4.0.0.tgz
...
phase2() {
    echo 'kafka already started (manually...) -> not anymore @23/06!'
...
broker-101.streaming.iaas.cib.gca.pem
broker-101.streaming.iaas.cib.gca.key
